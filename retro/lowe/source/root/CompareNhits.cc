  ...
  try
    {
      ...
      TH1D* hmeannoretroside = new TH1D("hmeannoretroside",";energy(MeV);mean of ncherenkovdigihits",11,4.5,15.5);
      for(int j = 0;j < (int)manager->listoffilelist["testnoretroside"].size();j++){
	TH1D* h1 = new TH1D("h1","",100,0.,100+j*10);
	double mean = 0.;
	double meanerror = 0.;
	AnalizeFile file = manager->SetTH1DEvent(h1,"ncherenkovdigihits","number","testnoretroside",j);
	double energy = 0.;
	...
	delete f1;
      ...
      TH1D* hmeannoretrocenter = new TH1D("hmeannoretrocenter",";energy(MeV);mean of ncherenkovdigihits",11,4.5,15.5);
      for(int j = 0;j < (int)manager->listoffilelist["testnoretrocenter"].size();j++){
	TH1D* h1 = new TH1D("h1","",100,0.,100+j*10);
	double mean = 0.;
	double meanerror = 0.;
	AnalizeFile file = manager->SetTH1DEvent(h1,"ncherenkovdigihits","number","testnoretrocenter",j);
	double energy = 0.;
	file.GetTagdouble("ParticleEnergyFixedValue",energy);
	TF1* f1 = new TF1("f1","gaus",0.,100+j*10.);
	h1->Fit(f1,"Rn");
	...
	delete f1;
      ...
      filemanageronretroside->narrowdowntag.push_back(AnalizeTag("ReflectivityFactorTrapezoidReflectivity","double",0.3));
      filemanageronretroside->narrowdowntag.push_back(AnalizeTag("EnergyFunctionName","string","OnRetro"));
      ...
      TH1D* hmeanonretroside = new TH1D("hmeanonretroside",";energy(MeV);mean of ncherenkovdigihits",11,4.5,15.5);
      for(int j = 0;j < (int)manager->listoffilelist["testonretroside"].size();j++){
	TH1D* h1 = new TH1D("h1","",100,0.,100+j*10);
	double mean = 0.;
	double meanerror = 0.;
	AnalizeFile file = manager->SetTH1DEvent(h1,"ncherenkovdigihits","number","testonretroside",j);
	double energy = 0.;
	file.GetTagdouble("ParticleEnergyFixedValue",energy);
	TF1* f1 = new TF1("f1","gaus",0.,100+j*10.);
	h1->Fit(f1,"Rn");
	...
	delete f1;
      ...
      filemanageronretrocenter->narrowdowntag.push_back(AnalizeTag("ReflectivityFactorTrapezoidReflectivity","double",0.3));
      filemanageronretrocenter->narrowdowntag.push_back(AnalizeTag("EnergyFunctionName","string","OnRetro"));
      ...
      TH1D* hmeanonretrocenter = new TH1D("hmeanonretrocenter",";energy(MeV);mean of ncherenkovdigihits",11,4.5,15.5);
      for(int j = 0;j < (int)manager->listoffilelist["testonretrocenter"].size();j++){
	TH1D* h1 = new TH1D("h1","",100,0.,100+j*10);
	double mean = 0.;
	double meanerror = 0.;
	AnalizeFile file = manager->SetTH1DEvent(h1,"ncherenkovdigihits","number","testonretrocenter",j);
	double energy = 0.;
	file.GetTagdouble("ParticleEnergyFixedValue",energy);
	TF1* f1 = new TF1("f1","gaus",0.,100+j*10.);
	h1->Fit(f1,"Rn");
	...
	delete f1;
      ...
      TLegend* l1 = new TLegend(0.3,0.78,0.6,0.88);
      ...
      hmeannoretroside->GetYaxis()->SetRangeUser(80.,200.);
