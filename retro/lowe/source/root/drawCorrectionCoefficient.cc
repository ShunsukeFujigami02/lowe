...
int main(int argc,char** argv)
{
  try
	...
	filemanager->narrowdowntag.push_back(AnalizeTag("ReflectivityFactorTrapezoidReflectivity","double",Getdouble("REFLECTIVITY")));
      ...
      std::string energyfunc = Getchar("ENERGYFUNC");
      filemanager->narrowdowntag.push_back(AnalizeTag("EnergyFunctionName","string",energyfunc));
      ...
      TH2D* h1 = new TH2D("h1","",5,-0.5,4.5,5,-0.5,4.5);
      manager->SetTH2DCorrectionCoefficientTrueAxis(h1,"test");
      TCanvas* c1 = new TCanvas("c1","");
      h1->GetXaxis()->SetBinLabel(1,"sqrt(x_rot^2+y_rot^2)");
      h1->GetXaxis()->SetBinLabel(2,"z_rot");
      h1->GetXaxis()->SetBinLabel(3,"t_rec - t_true");
      h1->GetXaxis()->SetBinLabel(4,"costheta_rot");
      h1->GetXaxis()->SetBinLabel(5,"k");
      h1->GetYaxis()->SetBinLabel(1,"sqrt(x_rot^2+y_rot^2)");
      h1->GetYaxis()->SetBinLabel(2,"z_rot");
      h1->GetYaxis()->SetBinLabel(3,"t_rec - t_true");
      h1->GetYaxis()->SetBinLabel(4,"costheta_rot");
      h1->GetYaxis()->SetBinLabel(5,"k");
